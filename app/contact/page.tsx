...
export default function Contact() {
  return (
    <div className="min-h-screen flex w-full justify-center items-center flex-col">
      <div className="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-6 bg-blue-400 w-full max-w-4xl p-8 md:p-12 lg:rounded-xl shadow-lg text-white overflow-hidden">
        <ContactInfo />
