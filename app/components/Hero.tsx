...
export default function Hero() {
  return (
    <div className="relative ">
      <div className="flex items-center justify-center h-[32rem] md:h-[37rem] bg-hero-bg bg-fixed bg-cover bg-center bg-norepeat before:content-[''] before:bg-hero-bg before:bg-cover before:bg-center before:-z-50 before:fixed before:top-0  before:right-0 before:left-0 before:bottom-0 -z-50"></div> 
