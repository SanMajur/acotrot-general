...
export default function Hero() {
  return (
    <div className="relative ">
      <div className=" h-[34rem] md:h-[40rem] bg-hero-bg md:bg-fixed bg-cover bg-center bg-norepeat"></div>
      <div className="h-[34rem] md:h-[40rem] absolute top-0 left-0 right-0 bg-black/40"></div>
