...
export default function Hero() {
  return (
    <div className="relative ">
      <div className="flex items-center justify-center h-[32rem] md:h-[37rem] bg-hero-bg bg-fixed bg-cover bg-center bg-norepeat fixed top-0 right-0 left-0 bottom-0 -z-50"></div>
